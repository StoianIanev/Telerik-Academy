...
//Task 9- We are given a string containing a list of forbidden words and a text containing some of these words. 
...
namespace ReplaceTheForbiddenWords
{
    class ReplaceTheForbiddenWords
    {
        static void Main()
        {
