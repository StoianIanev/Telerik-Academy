...
//Task 3- We are given a matrix of strings of size N x M. 
...
namespace _03.LongestSequenceInMatrix
{
    class LongestSequenceInMatrix
    {

        static void Sequence(int sequence,int LongerstSequence )
        {
            if (sequence > LongerstSequence)
            {
