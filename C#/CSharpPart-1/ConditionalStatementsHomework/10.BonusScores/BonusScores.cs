...
namespace _10.BonusScores
{
    class BonusScores
    {
        static void Main()
        {
            Console.Write("Enter number between 1 to 9: ");
            int input;
            ...
            if (result == true)
            {
                ...
                switch (input)
                {
                    ...
                    case 2:
                    case 3:
                        Console.WriteLine("Your score is: {0}", input * 10);
                        break;
                    case 4:
                    case 5:
                    case 6:
                        Console.WriteLine("Your score is: {0}", input * 100);
                        break;
                    case 7:
                    case 8:
                    case 9:
                        Console.WriteLine("Your score is: {0}", input * 1000);
                        break;
